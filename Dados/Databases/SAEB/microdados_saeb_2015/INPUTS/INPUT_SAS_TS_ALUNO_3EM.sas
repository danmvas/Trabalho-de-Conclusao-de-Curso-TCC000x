...
/*               3º SÉRIE DO ENSINO MÉDIO DA ANEB/PROVA BRASIL 2015                    */
/***************************************************************************************/
/***************************************************************************************/
/* Obs:                                                                                */
/* 		                                                                               */
...
INFILE 'C:\TS_ALUNO_3EM.csv'/*Endereço do arquivo*/
...
DESVIO_PADRAO_LP_SAEB : 18.
PROFICIENCIA_MT : 18.
DESVIO_PADRAO_MT : 17.
PROFICIENCIA_MT_SAEB  : 19.
DESVIO_PADRAO_MT_SAEB : 18.
...
IN_SITUACAO_CENSO = 'Indicador de Consistência com o Censo Escolar 2015'                                                                              
...
DESVIO_PADRAO_LP = 'Desvio padrão da proficiência em Língua Portuguesa'                                                                                
...
DESVIO_PADRAO_LP_SAEB = 'Desvio padrão da proficiência transformada em Língua Portuguesa'                                                              
...
DESVIO_PADRAO_MT = 'Desvio padrão da proficiência em Matemática'                                                                                       
...
DESVIO_PADRAO_MT_SAEB = 'Desvio padrão da proficiência transformada em Matemática'                                                                     
IN_PREENCHIMENTO_QUESTIONARIO = 'Indicador de preenchimento do questionário'
TX_RESP_Q001 = 'Qual é o seu sexo?'
TX_RESP_Q002 = 'Como você se considera?'
