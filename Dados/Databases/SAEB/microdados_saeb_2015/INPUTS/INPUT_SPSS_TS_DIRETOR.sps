...
VARIABLE LABELS TX_RESP_Q033 'Esta escola participou da Prova Brasil de 2011?'. 
VALUE LABELS TX_RESP_Q033
'A' 'Sim'
'B' 'Não'
'C' 'Não sei'.
VARIABLE LABELS TX_RESP_Q034 'Você conhece os resultados do SAEB (Prova Brasil e/ou ANEB) de 2011? Desta escola?'. 
VALUE LABELS TX_RESP_Q034
'A' 'Sim'
'B' 'Não'
'C' 'Minha escola não participou'.
VARIABLE LABELS TX_RESP_Q035 'Você conhece os resultados do SAEB (Prova Brasil e/ou ANEB) de 2011? Do seu município?'. 
VALUE LABELS TX_RESP_Q035
'A' 'Sim'
'B' 'Não'
'C' 'Meu município não participou'.
VARIABLE LABELS TX_RESP_Q036 'Você conhece os resultados do SAEB (Prova Brasil e/ou ANEB) de 2011? Do seu estado?'. 
