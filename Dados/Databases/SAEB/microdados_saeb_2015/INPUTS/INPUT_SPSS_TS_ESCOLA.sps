...
VARIABLE LABELS NU_MATRICULADOS_CENSO_5EF 'Número de alunos matriculados na 4ª Série/5º ano no censo 2015'.     
VARIABLE LABELS NU_PRESENTES_5EF 'Número de alunos presentes na 4ª/5º ano'.
VARIABLE LABELS TAXA_PARTICIPACAO_5EF 'Razão entre o total de alunos presentes na Prova Brasil (NU_PRESENTES_5ANO) e o total de alunos cadastrados no Censo Escolar que são público alvo da Prova Brasil (NU_MATRICULADOS_CENSO_5ANO)'.
...
VARIABLE LABELS TAXA_PARTICIPACAO_9EF 'Razão entre o total de alunos presentes na Prova Brasil (NU_PRESENTES_9ANO) e o total de alunos cadastrados no Censo Escolar que são público alvo da Prova Brasil (NU_MATRICULADOS_CENSO_9ANO)'.
