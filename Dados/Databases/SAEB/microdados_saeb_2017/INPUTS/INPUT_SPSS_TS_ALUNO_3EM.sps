...
/*                     3ª/4ª SÉRIE DO ENSINO MÉDIO DA ANEB 2017                                   	*/
/******************************************************************************************************************	/
/******************************************************************************************************************	/
/* Obs:                                                                                                                    	*/
/* 		                                                                                                 	*/
/* Para abrir os microdados é necessário salvar este programa e os arquivos                       	*/
/* TS_ALUNO_3EM_AG.CSV e TS_ALUNO_3EM_ESC.CSV no diretório C:\ do computador.	*/
/*							    	*/ 
...
GET DATA
  /TYPE=TXT
  /FILE="C:\TS_ALUNO_3EM_AG.csv" /*ou "C:\TS_ALUNO_3EM_ESC.csv"
  /DELCASE=LINE
  /DELIMITERS=","
...
1 'Prova preenchida'.
VARIABLE LABELS IN_PRESENCA_PROVA 'Indicador de presença na prova'.
VALUE LABELS IN_PRESENCA_PROVA
0 'Ausente'
1 'Presene'.
...
'K' 'Novembro.' 
'L' 'Dezembro.'.
VARIABLE LABELS TX_RESP_Q004 'Em que ano você nasceu?'.
...
VARIABLE LABELS TX_RESP_Q006 'Na sua casa tem rádio?'.
...
'A' 'Sim.' 
'B' 'Não.'.
VARIABLE LABELS TX_RESP_Q032 'Com qual frequência você lê: Revistas informativas em geral.'.
VALUE LABELS TX_RESP_Q032
'A' 'Sempre ou quase sempre.' 
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.'.
VARIABLE LABELS TX_RESP_Q033 'Com qual frequência você lê: Gibis.'.
VALUE LABELS TX_RESP_Q033
'A' 'Sempre ou quase sempre.' 
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.'.
VARIABLE LABELS TX_RESP_Q034 'Com qual frequência você lê: Livros em geral.'.
VALUE LABELS TX_RESP_Q034
'A' 'Sempre ou quase sempre.' 
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.'.
VARIABLE LABELS TX_RESP_Q035 'Com qual frequência você lê: Notícias e/ou textos na internet.'.
VALUE LABELS TX_RESP_Q035
'A' 'Sempre ou quase sempre.' 
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.'.
VARIABLE LABELS TX_RESP_Q036 'Em dias de aula, quanto tempo você gasta assistindo à TV, navegando na internet ou jogando jogos eletrônicos?'.
...
VARIABLE LABELS TX_RESP_Q037 'Em dias de aula, quanto tempo você gasta fazendo trabalhos domésticos (ex.: lavando louça, limpando o quintal etc.)?'.
...
VARIABLE LABELS TX_RESP_Q038 'Atualmente você trabalha fora de casa (recebendo ou não um salário)?'.
VALUE LABELS TX_RESP_Q038
'A' 'Sim.' 
'B' 'Não.'.
VARIABLE LABELS TX_RESP_Q039 'Quando você começou a estudar?'.
...
VARIABLE LABELS TX_RESP_Q040 'A partir da primeira série do Ensino Médio, em que tipo de escola você estudou?'.
VALUE LABELS TX_RESP_Q040
'A' 'Somente em escola pública.' 
'B' 'Somente em escola particular.' 
'C' 'Em escola pública e em escola particular.'.
VARIABLE LABELS TX_RESP_Q041 'Você já foi reprovado?'.
VALUE LABELS TX_RESP_Q041
'A' 'Não.' 
'B' 'Sim, uma vez.' 
'C' 'Sim, duas vezes ou mais.'.
VARIABLE LABELS TX_RESP_Q042 'Você já abandonou a escola durante o período de aulas e ficou fora da escola o resto do ano?'.
VALUE LABELS TX_RESP_Q042
'A' 'Não.' 
'B' 'Sim, uma vez.' 
'C' 'Sim, duas vezes ou mais.'.
VARIABLE LABELS TX_RESP_Q043 'Você concluiu o Ensino Fundamental na Educação de Jovens e Adultos(EJA), antigo supletivo?'.
VALUE LABELS TX_RESP_Q043
'A' 'Sim.' 
'B' 'Não.'.
VARIABLE LABELS TX_RESP_Q044 'Você gosta de estudar Língua Portuguesa?'.
VALUE LABELS TX_RESP_Q044
'A' 'Sim.' 
'B' 'Não.'.
VARIABLE LABELS TX_RESP_Q045 'Você faz o dever de casa de Língua Portuguesa?'.
VALUE LABELS TX_RESP_Q045
'A' 'Sempre ou quase sempre.' 
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.' 
'D' 'O(A) professor(a) não passa dever de casa.'.
VARIABLE LABELS TX_RESP_Q046 'O que você consulta para fazer o dever de casa de Língua Portuguesa? Jornais.'.
VALUE LABELS TX_RESP_Q046
'A' 'Sim.' 
'B' 'Não.' 
'C' 'O(A) professor(a) não passa dever de casa.' 
'D' 'Depois da primeira série.'.
VARIABLE LABELS TX_RESP_Q047 'O que você consulta para fazer o dever de casa de Língua Portuguesa? Revistas de Informação geral.'.
VALUE LABELS TX_RESP_Q047
'A' 'Sim.' 
'B' 'Não.' 
'C' 'O(A) professor(a) não passa dever de casa.'.
VARIABLE LABELS TX_RESP_Q048 'O que você consulta para fazer o dever de casa de Língua Portuguesa? Livros didáticos.'.
VALUE LABELS TX_RESP_Q048
'A' 'Sim.' 
'B' 'Não.' 
'C' 'O(A) professor(a) não passa dever de casa.'.
VARIABLE LABELS TX_RESP_Q049 'O que você consulta para fazer o dever de casa de Língua Portuguesa? Livros ou enciclopédias.'.
VALUE LABELS TX_RESP_Q049
'A' 'Sim.' 
'B' 'Não.' 
'C' 'O(A) professor(a) não passa dever de casa.'.
VARIABLE LABELS TX_RESP_Q050 'O que você consulta para fazer o dever de casa de Língua Portuguesa? Sites da internet.'.
VALUE LABELS TX_RESP_Q050
'A' 'Sim.' 
'B' 'Não.' 
'C' 'O(A) professor(a) não passa dever de casa.'.
VARIABLE LABELS TX_RESP_Q051 'O professor corrige o dever de casa de Língua Portuguesa?'.
VALUE LABELS TX_RESP_Q051
'A' 'Sempre ou quase sempre.' 
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.' 
'D' 'O(A) professor(a) não passa dever de casa.'.
VARIABLE LABELS TX_RESP_Q052 'Você gosta de estudar Matemática?'.
VALUE LABELS TX_RESP_Q052
'A' 'Sim.' 
'B' 'Não.'.
VARIABLE LABELS TX_RESP_Q053 'Você faz o dever de casa de Matemática?'.
VALUE LABELS TX_RESP_Q053
'A' 'Sempre ou quase sempre.' 
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.' 
'D' 'O(A) professor(a) não passa dever de casa.'.
VARIABLE LABELS TX_RESP_Q054 'O que você consulta para fazer o dever de casa de Matemática? Caderno.'.
VALUE LABELS TX_RESP_Q054
'A' 'Sim.' 
'B' 'Não.' 
'C' 'O(A) professor(a) não passa dever de casa.'.
VARIABLE LABELS TX_RESP_Q055 'O que você consulta para fazer o dever de casa de Matemática? Livros didáticos.'.
VALUE LABELS TX_RESP_Q055
'A' 'Sim.' 
'B' 'Não.' 
'C' 'O(A) professor(a) não passa dever de casa.'.
VARIABLE LABELS TX_RESP_Q056 'O que você consulta para fazer o dever de casa de Matemática? Material complementar.'.
VALUE LABELS TX_RESP_Q056
'A' 'Sim.' 
'B' 'Não.' 
'C' 'O(A) professor(a) não passa dever de casa.'.
VARIABLE LABELS TX_RESP_Q057 'O que você consulta para fazer o dever de casa de Matemática? Revistas e jornais.'.
VALUE LABELS TX_RESP_Q057
'A' 'Sim.' 
'B' 'Não.' 
'C' 'O(A) professor(a) não passa dever de casa.'.
VARIABLE LABELS TX_RESP_Q058 'O que você consulta para fazer o dever de casa de Matemática? Sites da internet.'.
VALUE LABELS TX_RESP_Q058
'A' 'Sim.' 
'B' 'Não.' 
'C' 'O(A) professor(a) não passa dever de casa.'.
VARIABLE LABELS TX_RESP_Q059 'O professor corrige o dever de casa de Matemática?'.
VALUE LABELS TX_RESP_Q059
'A' 'Sempre ou quase sempre.' 
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.' 
'D' 'O(A) professor(a) não passa dever de casa.'.
VARIABLE LABELS TX_RESP_Q060 'Você utiliza a biblioteca ou sala de leitura da sua escola?'.
VALUE LABELS TX_RESP_Q060
'A' 'Sempre ou quase sempre.' 
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.' 
'D' 'A escola não possui.'.
