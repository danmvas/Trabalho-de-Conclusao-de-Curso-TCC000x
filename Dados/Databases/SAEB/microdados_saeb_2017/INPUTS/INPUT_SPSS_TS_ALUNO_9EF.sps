...
VARIABLE LABELS ERRO_PADRAO_LP 'Desvio padrão da proficiência em Língua Portuguesa'.
...
'D' 'Completou a 8.ª série/9.º ano Ensino Fundamental, mas não completou o Ensino Médio.' 
...
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.'.
VARIABLE LABELS TX_RESP_Q033 'Com qual frequência você lê: Livros em geral.'.
VALUE LABELS TX_RESP_Q033
'A' 'Sempre ou quase sempre.' 
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.'.
VARIABLE LABELS TX_RESP_Q034 'Com qual frequência você lê: Livros de literatura.'.
VALUE LABELS TX_RESP_Q034
'A' 'Sempre ou quase sempre.' 
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.'.
VARIABLE LABELS TX_RESP_Q035 'Com qual frequência você lê: Revistas em geral.'.
VALUE LABELS TX_RESP_Q035
'A' 'Sempre ou quase sempre.' 
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.'.
VARIABLE LABELS TX_RESP_Q036 'Com qual frequência você lê: Revistas em quadrinhos (gibis).'.
VALUE LABELS TX_RESP_Q036
'A' 'Sempre ou quase sempre.' 
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.'.
VARIABLE LABELS TX_RESP_Q037 'Com qual frequência você lê: Revistas de comportamento, celebridades, esportes ou TV.'.
VALUE LABELS TX_RESP_Q037
'A' 'Sempre ou quase sempre.' 
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.'.
VARIABLE LABELS TX_RESP_Q038 'Com qual frequência você lê: Notícias na internet (ex.: blog, notícia).'.
VALUE LABELS TX_RESP_Q038
'A' 'Sempre ou quase sempre.' 
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.'.
VARIABLE LABELS TX_RESP_Q039 'Com qual frequência você costuma ir à biblioteca?'.
VALUE LABELS TX_RESP_Q039
'A' 'Sempre ou quase sempre.' 
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.'.
VARIABLE LABELS TX_RESP_Q040 'Com qual frequência você costuma ir ao cinema?'.
VALUE LABELS TX_RESP_Q040
'A' 'Sempre ou quase sempre.' 
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.'.
VARIABLE LABELS TX_RESP_Q041 'Com qual frequência você costuma ir a algum tipo de espetáculo ou exposição (teatro, museu, dança, música)?'.
VALUE LABELS TX_RESP_Q041
'A' 'Sempre ou quase sempre.' 
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.'.
VARIABLE LABELS TX_RESP_Q042 'Com qual frequência você participa de festas na sua vizinhaça ou comunidade?'.
VALUE LABELS TX_RESP_Q042
'A' 'Sempre ou quase sempre.' 
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.'.
VARIABLE LABELS TX_RESP_Q043 'Em dia de aula, quanto tempo você gasta assistindo à TV, navegando na internet ou jogando jogos eletrônicos?'.
...
VARIABLE LABELS TX_RESP_Q044 'Em dias de aula, quanto tempo você gasta fazendo trabalhos domésticos (ex.: lavando louça, limpando o quintal etc.)?'.
...
VARIABLE LABELS TX_RESP_Q045 'Atualmente você trabalha fora de casa (recebendo ou não um salário)?'.
VALUE LABELS TX_RESP_Q045
'A' 'Sim.' 
'B' 'Não.'.
VARIABLE LABELS TX_RESP_Q046 'Quando você entrou na escola?'.
...
VARIABLE LABELS TX_RESP_Q047 'A partir da quinta série ou sexto ano, em que tipo de escola você estudou?'.
VALUE LABELS TX_RESP_Q047
'A' 'Somente em escola pública.' 
'B' 'Somente em escola particular.' 
'C' 'Em escola pública e em escola particular.'.
VARIABLE LABELS TX_RESP_Q048 'Você já foi reprovado?'.
VALUE LABELS TX_RESP_Q048
'A' 'Não.' 
'B' 'Sim, uma vez.' 
'C' 'Sim, duas vezes ou mais.'.
VARIABLE LABELS TX_RESP_Q049 'Você já abandonou a escola durante o período de aulas e ficou fora da escola o resto do ano?'.
VALUE LABELS TX_RESP_Q049
'A' 'Não.' 
'B' 'Sim, uma vez.' 
'C' 'Sim, duas vezes ou mais.'.
VARIABLE LABELS TX_RESP_Q050 'Você gosta de estudar Língua Portuguesa?'.
VALUE LABELS TX_RESP_Q050
'A' 'Sim.' 
'B' 'Não.'.
VARIABLE LABELS TX_RESP_Q051 'Você faz o dever de casa de Língua Portuguesa?'.
VALUE LABELS TX_RESP_Q051
'A' 'Sempre ou quase sempre.' 
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.' 
'D' 'O(A) professor(a) não passa dever de casa.'.
VARIABLE LABELS TX_RESP_Q052 'O(A) professor(a) corrige o dever de casa de Língua Portuguesa?'.
VALUE LABELS TX_RESP_Q052
'A' 'Sempre ou quase sempre.' 
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.' 
'D' 'O(A) professor(a) não passa dever de casa.'.
VARIABLE LABELS TX_RESP_Q053 'Você gosta de estudar Matemática?'.
VALUE LABELS TX_RESP_Q053
'A' 'Sim.' 
'B' 'Não.'.
VARIABLE LABELS TX_RESP_Q054 'Você faz o dever de casa de Matemática?'.
VALUE LABELS TX_RESP_Q054
'A' 'Sempre ou quase sempre.' 
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.' 
'D' 'O(A) professor(a) não passa dever de casa.'.
VARIABLE LABELS TX_RESP_Q055 'O(A) professor(a) corrige o dever de casa de Matemática?'.
VALUE LABELS TX_RESP_Q055
'A' 'Sempre ou quase sempre.' 
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.' 
'D' 'O(A) professor(a) não passa dever de casa.'.
VARIABLE LABELS TX_RESP_Q056 'Você utiliza a biblioteca ou sala de leitura da sua escola?'.
VALUE LABELS TX_RESP_Q056
'A' 'Sempre ou quase sempre.' 
'B' 'De vez em quando.' 
'C' 'Nunca ou quase nunca.' 
'D' 'A escola não possui biblioteca ou sala de leitura.'.
VARIABLE LABELS TX_RESP_Q057 'Quando você terminar o 9º ano(8ª série) você pretende:'.
