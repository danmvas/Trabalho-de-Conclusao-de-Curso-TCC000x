...
# 
# TS_ALUNO_5EF$ID_DEPENDENCIA_ADM <- factor (TS_ALUNO_5EF$ID_DEPENDENCIA_ADM, levels = c (1,2,3,4),
...
# 
# TS_ALUNO_5EF$ID_TURNO <- factor (TS_ALUNO_5EF$ID_TURNO, levels = c (1,2,3),
