...
# 
# TS_SECRETARIO_MUNICIPAL$TX_RESP_Q001 <- factor (TS_SECRETARIO_MUNICIPAL$TX_RESP_Q001, levels = c ('A','B'),
#                                             labels = c('Masculino','Feminino'))
# 
# TS_SECRETARIO_MUNICIPAL$TX_RESP_Q003 <- factor (TS_SECRETARIO_MUNICIPAL$TX_RESP_Q003, levels = c ('A','B','C','D','E','F'),
#                                             labels = c('Branca','Preta','Parda','Amarela','Indígena','Não quero declarar'))
# 
# TS_SECRETARIO_MUNICIPAL$TX_RESP_Q004 <- factor (TS_SECRETARIO_MUNICIPAL$TX_RESP_Q004, levels = c ('A','B','C','D','E','F'),
#                                             labels = c('Ensino Fundamental','Ensino Médio','Graduação','Especialização','Mestrado','Doutorado'))
# 
# TS_SECRETARIO_MUNICIPAL$TX_RESP_Q005 <- factor (TS_SECRETARIO_MUNICIPAL$TX_RESP_Q005, levels = c ('A','B'),
#                                             labels = c('Sim','Não'))
# 
# TS_SECRETARIO_MUNICIPAL$TX_RESP_Q006 <- factor (TS_SECRETARIO_MUNICIPAL$TX_RESP_Q006, levels = c ('A','B'),
#                                             labels = c('Sim','Não'))
# 
# TS_SECRETARIO_MUNICIPAL$TX_RESP_Q007 <- factor (TS_SECRETARIO_MUNICIPAL$TX_RESP_Q007, levels = c ('A','B'),
#                                             labels = c('Sim','Não'))
# 
# TS_SECRETARIO_MUNICIPAL$TX_RESP_Q008 <- factor (TS_SECRETARIO_MUNICIPAL$TX_RESP_Q008, levels = c ('A','B'),
#                                             labels = c('Sim','Não'))
# 
# TS_SECRETARIO_MUNICIPAL$TX_RESP_Q009 <- factor (TS_SECRETARIO_MUNICIPAL$TX_RESP_Q009, levels = c ('A','B'),
#                                             labels = c('Sim','Não'))
# 
# TS_SECRETARIO_MUNICIPAL$TX_RESP_Q010 <- factor (TS_SECRETARIO_MUNICIPAL$TX_RESP_Q010, levels = c ('A','B'),
#                                             labels = c('Sim','Não'))
# 
# TS_SECRETARIO_MUNICIPAL$TX_RESP_Q011 <- factor (TS_SECRETARIO_MUNICIPAL$TX_RESP_Q011, levels = c ('A','B'),
#                                             labels = c('Sim','Não'))
# 
# TS_SECRETARIO_MUNICIPAL$TX_RESP_Q012 <- factor (TS_SECRETARIO_MUNICIPAL$TX_RESP_Q012, levels = c ('A','B'),
#                                             labels = c('Sim','Não'))
# 
# TS_SECRETARIO_MUNICIPAL$TX_RESP_Q013 <- factor (TS_SECRETARIO_MUNICIPAL$TX_RESP_Q013, levels = c ('A','B'),
#                                             labels = c('Sim','Não'))
# 
# TS_SECRETARIO_MUNICIPAL$TX_RESP_Q017 <- factor (TS_SECRETARIO_MUNICIPAL$TX_RESP_Q017, levels = c ('A','B'),
#                                             labels = c('Sim','Não'))
# 
# TS_SECRETARIO_MUNICIPAL$TX_RESP_Q018 <- factor (TS_SECRETARIO_MUNICIPAL$TX_RESP_Q018, levels = c ('A','B'),
#                                             labels = c('Sim','Não'))
# 
