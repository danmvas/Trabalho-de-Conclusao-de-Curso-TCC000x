...
12 '3ª/4ª Série do Ensino Médio Tradicional'
13 '3ª/4ª Série do Ensino Médio Integrado'.
...
VARIABLE LABELS IN_PROFICIENCIA_LP 'Indicador para cálculo da proficiência de Língua Portuguesa (no mínimo três itens respondidos no caderno de provas de Língua Portuguesa e Matemática)'.
VALUE LABELS IN_PROFICIENCIA_LP
0 'Não'
1 'Sim'.
VARIABLE LABELS IN_PROFICIENCIA_MT 'Indicador para cálculo da proficiência de Matemática (no mínimo três itens respondidos no caderno de provas de Língua Portuguesa e Matemática)'.
...
VARIABLE LABELS TX_RESP_Q019 'Quando terminar o Ensino Médio você pretende:'.
...
VARIABLE LABELS TX_RESP_Q020 'Você concluiu o Ensino Fundamental na Educação de Jovens e Adultos (EJA), antigo supletivo?'.
