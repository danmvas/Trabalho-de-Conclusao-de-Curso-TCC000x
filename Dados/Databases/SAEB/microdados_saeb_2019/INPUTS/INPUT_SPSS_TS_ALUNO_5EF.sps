...
CACHE.
EXECUTE.
DATASET NAME TS_ALUNO_5EF WINDOW=FRONT.
...
0 'Ausente'
1 'Presente'.
VARIABLE LABELS ID_CADERNO_LP 'Caderno de Provas de Língua Portuguesa'.
...
VARIABLE LABELS ID_CADERNO_MT 'Caderno de Provas de Matemática'.
